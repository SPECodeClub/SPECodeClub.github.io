...
function checkcomputerparts(){
	...
	if (question2 == "A number-crunching processor") {
		correct++;
}	
	if (question3 == "A CPU") {
		correct++;
...
function checkhowtousegithub(){
	...
	if (question1 == "Repository") {
		correct++;
}
	if (question2 == "Updates the online files") {
		correct++;
}	
	if (question3 == "Secret") {
		correct++;
...
function checkscratchbasics(){
	...
	if (question1 == "Lifelong Kindergarten Group") {
		correct++;
}
	if (question2 == "The stage") {
		correct++;
}	
	if (question3 == "Backdrop") {
		correct++;
	}
